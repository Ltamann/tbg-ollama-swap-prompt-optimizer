...
>
  <h1
    ...
    class="p-0 m-0 text-sm font-semibold leading-tight text-center outline-none hover:bg-gray-100 dark:hover:bg-gray-700 rounded px-1"
    onblur={handleBlur}
  ...
  <menu class="mt-1 flex items-center gap-4 overflow-x-auto">
    <a
      href="/"
      use:link
    ...
    <a
      ...
      use:link
      class="text-gray-600 hover:text-black dark:text-gray-300 dark:hover:text-gray-100 p-1 whitespace-nowrap"
      class:font-semibold={isActive("/settings", $location)}
    >
      Settings
    </a>
