...
{#if hasModels}
  <select
    class="min-w-0 flex-1 basis-48 px-3 h-9 rounded-full border border-gray-300/80 dark:border-white/10 bg-surface shadow-sm focus:outline-none focus:ring-0"
    bind:value
    {disabled}
  >
